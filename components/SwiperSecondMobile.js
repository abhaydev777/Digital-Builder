    ...
    >
      <SwiperSlide>
        ...
        <div className="card mt-6 w-[320px] lg:w-72 min-h-80 pt-5 pb-10 lg:h-64 bg-white border border-[#9D9797] backdrop-blur-sm flex flex-col justify-center items-start">
              ...
              <div className=" flex justify-start items-end gap-2 pt-10 pl-5">
                ...
                <div className="">
                    <h1 className='text-xl text-black'>Carlos lopez</h1>
...
SwiperSecondMobile.displayName = "SwiperSecondMobile";
export default SwiperSecondMobile